...
print("  3. Anypoint にある値 (URL、ID、状態) なら python3 scripts/portal-search.py '<項目名>' → 出た anypoint-api.py の行を流す")
print("     Anypoint 側の手順そのものなら bash scripts/plugin-root.sh --skill platform-assistant")
print("  4. 公式マニュアル")
